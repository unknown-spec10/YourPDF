...
export default function DocxToPdfPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await axios.post(`${API_URL}/api/docx-to-pdf`, formData, {
    ...
    <div className="mx-auto w-full max-w-3xl px-6 py-12 flex-1 flex flex-col justify-center">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted mt-1">Convert Microsoft Word (.docx) documents into high-quality PDFs.</p>
          </div>
        </div>
      </div>
        ...
        <AnimatePresence mode="wait">
          ...
          {file && !jobId && (
            ...
            >
              ...
              >
                {isSubmitting ? 'Initializing...' : 'Convert to PDF'}
              </button>
            </motion.div>
          )}
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted mt-1">
                      Your PDF file is ready. Click the button below to download.
                    </p>
                  </div>
      ...
      {isDone && jobStatus?.result && (
        <PdfPreviewModal
          ...
          fileName={file?.name ? `${file.name.replace(/\.[^/.]+$/, "")}.pdf` : "document.pdf"}
        />
      )}
    </div>
  )
